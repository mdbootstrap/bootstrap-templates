    ...
    <div class="jumbotron">
      <div class="container">
        ...
        <p>
            ...
            <a class="btn btn-primary" role="button" href="https://codeload.github.com/bootstrap-tagsinput/bootstrap-tagsinput/zip/latest">Download</a>
        </p>
        <p>
    ...
    source: function(query) {
      return $.get('http://someservice.com');
            ...
            <tr>
              ...
              <td><p>Boolean value controlling whether form submissions get processed when pressing enter in a field converted to a tagsinput (default: false).
                <pre><code data-language="javascript">$('input').tagsinput({
